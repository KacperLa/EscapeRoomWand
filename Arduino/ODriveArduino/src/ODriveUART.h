...
public:
     ...
     */
    void setPosition(const int axis, float position);

    /**
     * @brief Sends a new position setpoint with a velocity feedforward term.
     */
    void setPosition(const int axis, float position, float velocity_feedforward);

    /**
     * @brief Sends a new position setpoint with velocity and torque feedforward terms.
     */
    void setPosition(const int axis, float position, float velocity_feedforward, float torque_feedforward);
     ...
     */
    void setState(const int axis, ODriveAxisState requested_state);
     ...
     */
    ODriveAxisState getState(const int axis);
